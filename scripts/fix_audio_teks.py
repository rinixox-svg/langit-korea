...
# -*- coding: utf-8 -*-
"""
Fix audio_teks di listening_data.json:
1. Cek field 'audio_teks' yang kosong
2. Isi dengan audio script yang benar dari parsing sebelumnya
...
print("=== FIX AUDIO_TEKS DI LISTENING DATA ===\n")
...
for unit_num in range(31, 61):
    ...
    for soal in soal_list:
        ...
        if not audio_teks:
            # Cek apakah ada field 'audio_script' atau 'script'
...
laporan_path = output_dir / "laporan_fix_audio_teks.json"
