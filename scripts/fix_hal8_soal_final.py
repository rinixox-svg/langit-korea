...
# -*- coding: utf-8 -*-
"""
Script untuk memperbaiki parsing hal8_soal.txt
- Instruction patterns -> field "instruksi"
- Question text -> field "teks_soal"
- Answer choices ①, ②, ③, ④ -> pilihan_a, pilihan_b, pilihan_c, pilihan_d
"""
...
print("=== FIX HAL8_SOAL.TXT 30 UNIT ===\n")
    ...
    for soal in soal_list:
        ...
        for p in parsed:
            if p["nomor"] == nomor:
                # Update fields
                if p["teks_soal"] and (
                    not soal.get("teks_soal") or "①" in soal.get("teks_soal", "")
                ):
